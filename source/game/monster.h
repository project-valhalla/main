...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_GUARD,  ATK_PULSE1,   15,  0, 200, 50, 8, 1,  60, 100, 100, 4, 14, 140, 0x60FFFF, S_GUARD_PAIN,   S_GUARD_DEATH,   S_GUARD_HALT,   S_GUARD_ATTACK,  "guard",       "monster/guard",  "monster/guard/weapon",    false, true,  true  },
    ...
    { MTYPE_SPIDER, ATK_MELEE,    19,  0,  30, 30, 0, 1,   0, 200, 400, 1,  7,  20, 0xFF90FF, S_SPIDER_PAIN,  S_SPIDER_DEATH,  S_SPIDER_HALT,  S_SPIDER_ATTACK, "generantula", "monster/spider", NULL,                      false, false, false }
};
