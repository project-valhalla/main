...
} attacks[NUMATKS] =
{
    ...
    { GUN_PISTOL,  ACT_SECONDARY,  600,  15,  0,   0, 5, 1000, 20, 2048,  1, 500,  8,  800, 2,    0,    0, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_PISTOL2,       S_IMPACT_PULSE,   S_HIT_WEAPON  },
    // instagib
