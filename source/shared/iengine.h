...
enum
{
    ...
    PART_SPARK, PART_SPARK2, PART_SPARK3, PART_EXPLODE1, PART_EXPLODE2, PART_EXPLODE3, PART_EXPLODE4, PART_ELECTRICITY,
    PART_EDIT, PART_ORB, PART_RING,
...
extern void particle_text(const vec &s, const char *t, int type, int fade = 2000, int color = 0xFFFFFF, float size = 2.0f, int gravity = 0, float maxsize = 0);
extern void particle_textcopy(const vec &s, const char *t, int type, int fade = 2000, int color = 0xFFFFFF, float size = 2.0f, int gravity = 0, float maxsize = 0);
...
extern void particle_flare(const vec &p, const vec &dest, int fade, int type, int color = 0xFFFFFF, float size = 0.28f, float maxsize = 0, physent* owner = NULL, int track = TRACK_MUZZLE);
...
extern void rendermodel(const char *mdl, int anim, const vec &o, float yaw = 0, float pitch = 0, float roll = 0, int cull = MDL_CULL_VFC | MDL_CULL_DIST | MDL_CULL_OCCLUDED, dynent *d = NULL, modelattach *a = NULL, int basetime = 0, int basetime2 = 0, float size = 1, const vec4 &color = vec4(1, 1, 1, 1), const vec &translation = vec(0, 0, 0));
