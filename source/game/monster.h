...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_BRUTE,  ATK_PISTOL2,  ATK_MELEE2, 12,  0, 100,  25, 0, 3,   0, 100, 800, 1, 12, 100, 0x60FFFF, S_OGRO_PAIN,    S_OGRO_DEATH,    S_OGRO_HALT,    S_OGRO_HALT,    -1,              -1,               "brute",       "monster/ogro",   "weapon/pistol/world",     false, false, true  },
