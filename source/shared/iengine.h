...
extern void setconsolefontsize();
...
struct conspan;
struct font;
extern bool init_ttf();
extern bool setfont(font *f, const char *script = NULL);
extern bool setfont(const char *name, const char *script = NULL);
extern void setfontsize(int pts);
extern void pushfont();
extern bool popfont();
extern void closefont(font *f);
extern void gettextres(int &w, int &h);
extern void clearglyphcache();
extern void draw_text(textinfo info, float left, float top, int r = 255, int g = 255, int b = 255, int a = 255);
extern void draw_text(const char *str, float left, float top, int r = 255, int g = 255, int b = 255, int a = 255);
extern void draw_textf(const char *fstr, float left, float top, ...) PRINTFARGS(1, 4);
extern void text_prepare_colored(const char *str, textinfo &info, bvec initial_color, uchar a = 255);
extern void text_prepare(const char *str, textinfo &surf, int maxwidth);
...
extern void particle_text(const vec &s, const char *t, int type, int fade = 2000, int color = 0xFFFFFF, float size = 2.0f, int gravity = 0, const char *font = "wide", const char *script = "Latn");
extern void particle_textcopy(const vec &s, const char *t, int type, int fade = 2000, int color = 0xFFFFFF, float size = 2.0f, int gravity = 0, const char *font = "wide", const char *script = "Latn");
