...
These models were created from scratch in Blender 2.79, exported to Wavefront format (.obj), and use textures legaly downloaded from "textures.com" and/or "cc0textures.com". All used textures have been modified in GIMP 2.8, and/or ImageMagick. They are made with only my Valhalla maps in mind, but if other mappers can reuse them in their maps, they are most welcome to do so. However, I would appreciate if you didn't use these models outside of Valhalla.
