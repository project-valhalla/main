...
enum
{
    ...
    S_VC_HELLO, S_VC_HELP, S_VC_NICESHOT, S_VC_NO, S_VC_SORRY, S_VC_SUCK, S_VC_TAKEFLAG,
    S_VC_THANKYOU, S_VC_YEAH,

    S_VC_ATTACK2, S_VC_BASE2, S_VC_DEFEND2, S_VC_COVER2, S_VC_DROPFLAG2, S_VC_GOODJOB2,
    S_VC_HELLO2, S_VC_HELP2, S_VC_NICESHOT2, S_VC_NO2, S_VC_SORRY2, S_VC_SUCK2, S_VC_TAKEFLAG2,
    S_VC_THANKYOU2, S_VC_YEAH2,
