...
static fireballrenderer explosions("data/texture/particle/explosion01.png"), energybursts("data/texture/particle/explosion02.png"), fireballs("data/texture/particle/explosion03.png");
