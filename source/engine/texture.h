...
struct Slot
{
    ...
    virtual const char *texturedir() const { return "data/texture/world"; }
...
struct DecalSlot : Slot, VSlot
{
    ...
    const char *name() const;
    const char *texturedir() const { return "data/texture/decal"; }
...
extern Shader *nullshader, *hudshader, *hudnotextureshader, *nocolorshader, *foggedshader, *foggednotextureshader, *ldrshader, *ldrnotextureshader, *stdworldshader;
