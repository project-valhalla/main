...
static fireballrenderer explosions("data/texture/particle/fireball_pulse.png"), energybursts("data/texture/particle/fireball_energy.png"), fireballs("data/texture/particle/fireball.png");
