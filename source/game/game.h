...
enum
{
    ...
    S_POWERUP,
    S_DAMAGE, S_HASTE, S_ARMOR, S_UAMMO, S_AGILITY, S_INVULNERABILITY,
    S_ACTION_DAMAGE, S_ACTION_HASTE, S_ACTION_ARMOR, S_ACTION_UAMMO, S_ACTION_INVULNERABILITY,
    S_LOOP_DAMAGE, S_LOOP_HASTE, S_LOOP_ARMOR, S_LOOP_UAMMO, S_LOOP_AGILITY, S_LOOP_INVULNERABILITY,
    S_TIMEOUT_DAMAGE, S_TIMEOUT_HASTE, S_TIMEOUT_ARMOR, S_TIMEOUT_UAMMO, S_TIMEOUT_AGILITY, S_TIMEOUT_INVULNERABILITY,
    ...
    S_WEAPON_LOAD, S_WEAPON_NOAMMO, S_WEAPON_DETONATE,
    ...
    S_GUARD_PAIN, S_GUARD_DEATH, S_GUARD_HALT, S_GUARD_UNHALT, S_GUARD_ATTACK,
    S_BAUUL_PAIN, S_BAUUL_DEATH, S_BAUUL_HALT,
    S_SPIDER_PAIN, S_SPIDER_DEATH, S_SPIDER_HALT, S_SPIDER_ATTACK,
