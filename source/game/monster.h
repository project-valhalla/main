...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_LURKER, ATK_MELEE,    20,  0,  50, 3,   0, 100, 100, 1, 13,  75, 0xFFFF90, S_HELLPIG_PAIN, S_HELLPIG_DEATH, S_HELLPIG_HALT, "lurker",      "monster/lurker", NULL,                      false, true  },
    { MTYPE_SPIDER, ATK_MELEE,    19, 30,  30, 1,   0, 200, 400, 1,  7,  20, 0xFF90FF, S_SPIDER_PAIN,  S_SPIDER_DEATH,  S_SPIDER_HALT,  "cybercrab",   "monster/spider", NULL,                      false, false }
};
