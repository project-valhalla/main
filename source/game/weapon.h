...
{
    int gun, action, projectile, attackdelay, damage, headshotdamage, spread, range, rays, hitpush, exprad, use;
    bool isfullauto;
...
} attacks[NUMATKS] =
{
    ...
    // pulse
    { GUN_PULSE,   ACT_PRIMARY,      Projectile_Pulse,  180,  22,  0,   0, 2048,  1,   80, 18,  2, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_PULSE1,   S_PULSE_EXPLODE,   S_HIT_WEAPON,  Death_Explosion },
    { GUN_PULSE,   ACT_SECONDARY,  Projectile_Invalid,   80,  14,  0,   0,  200,  1,  150,  0,  1, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SECONDARY, S_PULSE2_A, S_IMPACT_PULSE,    S_HIT_WEAPON,  Death_Shock     },
    // rocket
    { GUN_ROCKET,  ACT_PRIMARY,     Projectile_Rocket,  920, 110,  0,   0, 2048,  1,  120, 33,  1, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_ROCKET1,  S_ROCKET_EXPLODE,  S_HIT_WEAPON,  Death_Explosion },
    { GUN_ROCKET,  ACT_IDLE,       Projectile_Invalid,    0, 120,  0,   0, 2048,  1,  140, 38,  0, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_INVALID,  S_ROCKET_EXPLODE,  S_HIT_WEAPON,  Death_Explosion },
    // railgun
    { GUN_RAIL,    ACT_PRIMARY,     Projectile_Tracer, 1200,  70, 30,   0, 4096,  1,  100,  0,  1, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_RAIL_A,   S_IMPACT_RAILGUN,  S_HIT_RAILGUN, Death_Default   },
    { GUN_RAIL,    ACT_SECONDARY,   Projectile_Tracer, 1500, 100, 10,   0, 4096,  1,  100,  0,  1, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_RAIL_A,   S_IMPACT_RAILGUN,  S_HIT_RAILGUN, Death_Default   },
    // grenade launcher
    { GUN_INVALID, ACT_THROW,      Projectile_Grenade, 1000,  90,  0,   0, 2048,  1,  140, 45,  0, false, ANIM_THROW, ANIM_VWEP_THROW, ANIM_GUN_THROW,     S_THROW,    S_GRENADE_EXPLODE, S_HIT_WEAPON,  Death_Explosion },
    { GUN_INVALID, ACT_IDLE,       Projectile_Invalid,    0, 100,  0,   0, 2048,  1,  160, 50,  0, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_INVALID,  S_GRENADE_EXPLODE, S_HIT_WEAPON,  Death_Explosion },
    // pistol
    { GUN_PISTOL,  ACT_PRIMARY,     Projectile_Tracer,  300,  18, 17,  10, 1024,  1,  180,  0,  1, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_PISTOL1,  S_IMPACT_PULSE,    S_HIT_WEAPON,  Death_Default   },
    { GUN_PISTOL,  ACT_SECONDARY,   Projectile_Plasma,  600,  15,  0,   0, 2048,  1,  500,  8,  2, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_PISTOL2,  S_IMPACT_PULSE,    S_HIT_WEAPON,  Death_Explosion },
    { GUN_PISTOL,  ACT_IDLE,       Projectile_Invalid,    0,  80,  0,   0, 2048,  1, -200, 50,  0, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_INVALID,  S_IMPACT_PISTOL,   S_HIT_RAILGUN, Death_Disrupt   },
    // instagib
    { GUN_INSTA,   ACT_PRIMARY,    Projectile_Invalid, 1200,  -1, 50,   0, 4096,  1,   90,  0,  0, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_PRIMARY,   S_INSTAGUN, S_IMPACT_RAILGUN,  S_HIT_WEAPON,  Death_Default   },
    // zombie
    { GUN_ZOMBIE,  ACT_MELEE,        Projectile_Melee,  600, 100,  0,   0,   28,  1,   20,  0,  0, false, ANIM_MELEE, ANIM_VWEP_MELEE, ANIM_GUN_MELEE,     S_ZOMBIE,   S_IMPACT_MELEE,    S_HIT_MELEE,   Death_Fist      }
};
