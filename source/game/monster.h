...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_GRAY,   ATK_SCATTER1, 14,  0, 120, 30, 0, 1, 100, 300, 400, 4, 15,  60, 0xFFFF90, S_RATA_PAIN,    S_RATA_DEATH,    S_RATA_HALT,    NULL,            "gray",      "monster/gray",   "weapon/scattergun/world", false, false, false },
    { MTYPE_GUARD,  ATK_PULSE1,   15,  0, 200, 50, 8, 1,  80, 400, 300, 4, 14, 140, 0x60FFFF, S_GUARD_PAIN,   S_GUARD_DEATH,   S_GUARD_HALT,   S_GUARD_ATTACK,  "guard",     "monster/guard",  "monster/guard/weapon",    false, false, true  },
