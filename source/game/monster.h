...
{
    { MTYPE_PLAYER, ATK_PULSE1,   ATK_MELEE,  20,  0, 100,  25, 0,  0, 200, 100, 100, 1, 12, 100, 0x60FFFF, S_PAIN_MALE,    S_DIE_MALE1,     S_TAUNT_MALE,   -1,             -1,              -1,               "clone",       "player/bones",   "weapon/pulserifle/world", false, false, true  },
    ...
    { MTYPE_SPIDER, ATK_MELEE2,   -1,         19,  0,  30,  25, 0,  3,   0, 200, 400, 1,  7,  20, 0xFF90FF, S_SPIDER_PAIN,  S_SPIDER_DEATH,  S_SPIDER_HALT,  -1,             S_SPIDER_ATTACK, S_SPIDER_INFIGHT, "generantula", "monster/spider", NULL,                      false, true,  false }
};
