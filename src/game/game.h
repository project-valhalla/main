...
#define devpassword "4NDR0M3D4_dev_"
#define godpassword "P3G45U5_god_"
...
enum
{
    ...
    S_HEAD_HIT,
    S_WATER_IMPACT, S_WATER_IMPACT_PROJ, S_GLASS_IMPACT, S_GLASS_IMPACT_PROJ,

    S_ROCKET_BOUNCE, S_GRENADE_BOUNCE,
    ...
    S_ANNOUNCER_HEADSHOT, S_ANNOUNCER_FACE_PUNCH, S_ANNOUNCER_HEAD_HUNTER, S_ANNOUNCER_ANNIHILATOR,
    S_ANNOUNCER_DDAMAGE, S_ANNOUNCER_HASTE, S_ANNOUNCER_ARMOUR, S_ANNOUNCER_UAMMO,
    S_ANNOUNCER_INVULNERABILITY,
    ...
    // SPECIAL SOUNDS FOR CLOSED SOURCE VERSIONS

    S_INFINITY, S_SHOOTINGS, S_URSS, S_MR_STARK
};

// network messages codes, c2s, c2c, s2c

enum { PRIV_NONE = 0, PRIV_MASTER, PRIV_AUTH, PRIV_ADMIN, PRIV_DEV };
...
enum
{
    ...
    N_GODMODE, N_PRIVILEGE, N_SPECIAL,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_GODMODE, 3, N_PRIVILEGE, 3, N_SPECIAL, 0,
    ...
    N_MASTERMODE, 2, N_KICK, 0, N_CLEARBANS, 1, N_CURRENTMASTER, 0, N_SPECTATOR, 4, N_SETMASTER, 0, N_SETTEAM, 0,
...
static const struct attackinfo { int gun, action, anim, vwepanim, hudanim, sound, impactsound, hitsound,
                                     attackdelay, damage, bonus, spread, margin, projspeed, kickamount, range, rays, hitpush, exprad, lifetime, use; } attacks[NUMATKS] =
{
    ...
    //shotgun
    { GUN_SG,       ACT_PRIMARY, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT,         S_SG1A,   S_SMG_HIT1,   S_SMG_HIT2, 1080,    6,   0, 380,   0,    0,   0,  650, 20,  50,  0,    0, 1 },
...
enum
{
    ...
    K_ZOMBIE = 1<<9, K_JUGGERNAUT = 1<<10
};
