...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_GUARD,  ATK_PULSE1,   15,  0, 200, 50, 1,  80, 400, 300, 4, 14, 140, 0x60FFFF, S_GUARD_PAIN,   S_GUARD_DEATH,   S_GUARD_HALT,   S_GUARD_ATTACK,  "guard",     "monster/guard",  "monster/guard/weapon",    false, false, true  },
