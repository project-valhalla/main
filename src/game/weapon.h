...
} attacks[NUMATKS] =
{
    ...
    { NULL,       ACT_MELEE,     650,  60,  0,   0, 2,    0,  0,   14,  1,  30,  0,    0, 0, ANIM_MELEE, ANIM_VWEP_MELEE, ANIM_GUN_MELEE, S_MELEE,         S_HIT_MELEE,      S_HIT_MELEE,  },
    // shotgun
    { GUN_SG,     ACT_PRIMARY,  1000,   5,  0, 260, 0,    0,  0, 1000, 20,  50,  0,    0, 1, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SG1_A,         S_IMPACT_SG,      S_HIT_WEAPON  },
    ...
    // smg
    { GUN_SMG,    ACT_PRIMARY,   110,  30, 30,  84, 0,    0,  0, 1000,  1,  20,  0,    0, 1, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SMG,           S_IMPACT_SMG,     S_HIT_WEAPON  },
    { GUN_SMG,    ACT_SECONDARY, 240,  35, 40,  30, 0,    0,  0, 1000,  1,  40,  0,    0, 1, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SMG,           S_IMPACT_SMG,     S_HIT_WEAPON  },
    // pulse
    ...
    // railgun
    { GUN_RAIL,   ACT_PRIMARY,  1200, 100, 40,   0, 0,    0, 40, 4000,  1, 110,  0,    0, 1, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_RAIL_A,        S_IMPACT_RAILGUN, S_HIT_RAILGUN },
    // pistol
    { GUN_PISTOL, ACT_PRIMARY,   300,  35,  5,   0, 0,    0,  0, 1000,  1, 200,  0,    0, 1, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_PISTOL1,       S_IMPACT_PULSE,   S_HIT_WEAPON  },
    { GUN_PISTOL, ACT_SECONDARY, 600,  15,  0,   0, 5, 1000,  0, 2048,  1, 500,  8,  800, 2, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_PISTOL2,       S_IMPACT_PULSE,   S_HIT_WEAPON  },
    // instagib
