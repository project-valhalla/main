...
static const monstertype monstertypes[NUMMONSTERS] =
{
    ...
    { MTYPE_BRUTE,  ATK_PISTOL2,  ATK_MELEE2, 12,  0, 100, 25, 0, 3,   0, 100, 800, 1, 12, 100, 0x60FFFF, S_OGRO_PAIN,    S_OGRO_DEATH,    S_OGRO_HALT,    S_OGRO_HALT,    NULL,            "brute",       "monster/ogro",   "monster/ogro/weapon",     false, false, true  },
    ...
    { MTYPE_GUARD,  ATK_PULSE1,   ATK_MELEE2, 15,  0, 200, 50, 8, 1,  60, 100, 100, 4, 14, 140, 0x60FFFF, S_GUARD_PAIN,   S_GUARD_DEATH,   S_GUARD_HALT,   S_GUARD_UNHALT, S_GUARD_ATTACK,  "guard",       "monster/guard",  "monster/guard/weapon",    false, true,  true  },
