...
{
    // main weapons
    GUN_SCATTER = 0, GUN_SMG, GUN_PULSE, GUN_ROCKET, GUN_RAIL, GUN_PISTOL,
...
} attacks[NUMATKS] =
{
    ...
    // shotgun
    { GUN_SCATTER, ACT_PRIMARY,    880,   5,  0, 260, 0,    0,  0, 1000, 20,  50,  0,    0, 1,    0,    0, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SG1_A,         S_IMPACT_SG,      S_HIT_WEAPON  },
    { GUN_SCATTER, ACT_SECONDARY,  600,  65,  0,   0, 2,  180,  0, 2048,  1,  60, 30, 2000, 2, 1.0f,    0, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SG2,           S_ROCKET_EXPLODE, S_HIT_WEAPON  },
    // smg
    ...
    { GUN_ROCKET,  ACT_SECONDARY,  920, 110,  0,   0, 0,  200,  0, 2048,  1, 120, 33, 1500, 1, 0.8f, 0.7f, false, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_ROCKET2,       S_ROCKET_EXPLODE, S_HIT_WEAPON  },
    // railgun
