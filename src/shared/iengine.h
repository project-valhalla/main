...
enum
{
    PART_BLOOD1 = 0, PART_BLOOD2,
    PART_WATER, PART_GLASS, PART_SMOKE, PART_STEAM, PART_FLAME, PART_SNOW,
    PART_TRAIL, PART_TRAIL_PROJECTILE,
    PART_LIGHTNING,
    PART_EXPLOSION1, PART_EXPLOSION2,
    PART_SPARK1, PART_SPARK2, PART_EDIT, PART_ORB,
    PART_MUZZLE_FLASH1, PART_MUZZLE_FLASH2, PART_MUZZLE_FLASH3,
    PART_HUD_ICON, PART_HUD_ICON_GREY,
    PART_LIGHT, PART_MODEL, PART_PLAYER, PART_ENTITY, PART_PARTICLE, PART_SOUND,
    PART_TEXT,
...
extern void particle_splash(int type, int num, int fade, const vec &p, int color = 0xFFFFFF, float size = 1.0f, int radius = 150, int gravity = 2, float grow = 0);
...
extern void particle_flare(const vec &p, const vec &dest, int fade, int type, int color = 0xFFFFFF, float size = 0.28f, physent *owner = NULL, float grow = 0);
...
extern void startmusic(char *name, char *cmd = NULL);
extern void stopmusic(int fade = 0);
