...
} attacks[NUMATKS] =
{
    ...
    { GUN_PULSE,   ACT_SECONDARY,   80,  12,  0,   0, 0,    0,  0,  200,  1, 100,  0,    0, 1,    0,    0, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT2, S_PULSE2_A,      S_IMPACT_PULSE,    S_HIT_WEAPON  },
    // rocket
    ...
    // instagib
    { GUN_INSTA,   ACT_PRIMARY,   1200,   1,  0,   0, 0,    0, 50, 4000,  1,  30,  0,    0, 0,    0,    0, true,  ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT,  S_RAIL_INSTAGIB, S_IMPACT_RAILGUN,  S_HIT_WEAPON  },
    // zombie
