...
*Disclaimer: anything written below is not set in stone, the project is open to discussion, suggestions and ideas.

Things I'd like to do add to the game sometime in the future:

------------------ GENERAL/GAME DIRECTION --------------------

the aim is to create a quality game which is easy to learn (and difficult to master) and focuses on both competitive and casual gameplay.
How? by creating a fps arena with casual, fun modes such as Infection, Gunball, Invasion (online Sauerbraten DMSP), boss mode and other cool stuff!
...
- movement and weapons tutorials for new comers;
