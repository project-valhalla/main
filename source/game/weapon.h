...
} attacks[NUMATKS] =
{
    ...
    { GUN_INVALID, ACT_MELEE,	     Projectile_Melee,  650,  60,  0,   0,    0,   28,  1,   50,  0,  290, 0,    0,    0, false, ANIM_MELEE, ANIM_VWEP_MELEE, ANIM_GUN_MELEE,     S_MELEE,         S_IMPACT_MELEE,    S_HIT_MELEE,   Death_Fist},
